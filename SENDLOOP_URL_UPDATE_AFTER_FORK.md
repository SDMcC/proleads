...
3. User is redirected to: `https://drip-campaign-hub.preview.emergentagent.com/dashboard?sso_token=eyJ...`
...
2. **Call the NEW Proleads API URL** to verify the token:
   ```
   POST https://marketer-auth-bridge.preview.emergentagent.com/api/sso/verify
   ```
...
1. **Check environment variable is loaded:**
   ...
   # Should output: https://marketer-auth-bridge.preview.emergentagent.com
   ```
...
**Proleads Current URL:** https://marketer-auth-bridge.preview.emergentagent.com  
