...
class ProleadsIntegration:
    def __init__(self):
        ...
        # ✅ NEW
        self.api_url = os.environ.get("PROLEADS_API_URL", "https://marketer-auth-bridge.preview.emergentagent.com")
...
USER_TOKEN=$(curl -s "https://marketer-auth-bridge.preview.emergentagent.com/api/auth/login" \
  -H "Content-Type: application/json" \
...
| Endpoint | Method | URL |
|----------|--------|-----|
| SSO Initiate | POST | `https://marketer-auth-bridge.preview.emergentagent.com/api/sso/initiate` |
| SSO Verify | POST | `https://marketer-auth-bridge.preview.emergentagent.com/api/sso/verify` |
| SSO User Info | GET | `https://marketer-auth-bridge.preview.emergentagent.com/api/sso/user-info` |
| CSV Export | POST | `https://marketer-auth-bridge.preview.emergentagent.com/api/integrations/csv-export` |
| CSV List | GET | `https://marketer-auth-bridge.preview.emergentagent.com/api/integrations/csv-files` |
...
### For Preview/Testing:
- Use: `https://marketer-auth-bridge.preview.emergentagent.com`
...
- [ ] Update `PROLEADS_API_URL` to `https://marketer-auth-bridge.preview.emergentagent.com`
