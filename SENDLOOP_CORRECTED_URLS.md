...
class ProleadsIntegration:
    def __init__(self):
        ...
        # ✅ NEW
        self.api_url = os.environ.get("PROLEADS_API_URL", "https://smartlead-hub-2.preview.emergentagent.com")
...
USER_TOKEN=$(curl -s "https://smartlead-hub-2.preview.emergentagent.com/api/auth/login" \
  -H "Content-Type: application/json" \
...
| Endpoint | Method | URL |
|----------|--------|-----|
| SSO Initiate | POST | `https://smartlead-hub-2.preview.emergentagent.com/api/sso/initiate` |
| SSO Verify | POST | `https://smartlead-hub-2.preview.emergentagent.com/api/sso/verify` |
| SSO User Info | GET | `https://smartlead-hub-2.preview.emergentagent.com/api/sso/user-info` |
| CSV Export | POST | `https://smartlead-hub-2.preview.emergentagent.com/api/integrations/csv-export` |
| CSV List | GET | `https://smartlead-hub-2.preview.emergentagent.com/api/integrations/csv-files` |
...
### For Preview/Testing:
- Use: `https://smartlead-hub-2.preview.emergentagent.com`
...
- [ ] Update `PROLEADS_API_URL` to `https://smartlead-hub-2.preview.emergentagent.com`
