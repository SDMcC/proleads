...
// NotificationPanel Component - Now imported from components/dashboard/NotificationPanel.js
// Enhanced Account Tab Component with sub-tabs
// AccountTab Component - Now imported from components/dashboard/tabs/AccountTab.js
// Notification Settings Tab Component
// NotificationSettingsTab Component - Now imported from components/dashboard/tabs/NotificationSettingsTab.js
// KYC Verification Tab Component
// KYCVerificationTab Component - Now imported from components/dashboard/tabs/KYCVerificationTab.js
  const [kycStatus, setKycStatus] = useState(null);
  const [loading, setLoading] = useState(true);
