...
import { MessageCircle, Send, Clock, CheckCircle, AlertCircle, ArrowLeft, Paperclip, X, Circle, Plus, Eye, Fuel, XCircle, Search, Filter } from 'lucide-react';
        ...
        <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6">
          ...
          <div className="flex space-x-4">
            <button
              ...
              disabled={!createForm.subject || !createForm.message || loading}
            ...
            <button
              onClick={() => setActiveView('list')}
              disabled={loading}
              className="px-6 py-3 bg-gray-600 hover:bg-gray-700 disabled:bg-gray-500 disabled:cursor-not-allowed text-white rounded-lg font-medium"
            >
              Cancel
            </button>
          </div>
