...
```
https://marketer-auth-bridge.preview.emergentagent.com/api/payments/depay/configuration
```
...
1. **Go to payment page:** https://marketer-auth-bridge.preview.emergentagent.com/payment
...
**Configuration Endpoint:** https://marketer-auth-bridge.preview.emergentagent.com/api/payments/depay/configuration
