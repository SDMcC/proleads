...
```
https://marketer-auth-bridge.preview.emergentagent.com/api/payments/callback
```

**For commission payouts:**
```
https://marketer-auth-bridge.preview.emergentagent.com/api/payout-callback
```
...
3. Ensure the callback URL is set to: `https://marketer-auth-bridge.preview.emergentagent.com/api/payments/callback`
