...
```bash
PROLEADS_API_URL=https://smartlead-hub-2.preview.emergentagent.com  # ✅ Correct URL
...
3. **Sendloop tries to verify token** with Proleads API ❌ (This fails)
   ...
   - But should call: `https://smartlead-hub-2.preview.emergentagent.com/api/sso/verify`
...
axios.post(
  'https://smartlead-hub-2.preview.emergentagent.com/api/sso/verify',
  { sso_token: 'test' },
  {
    headers: {
...
| Endpoint | Full URL |
|----------|----------|
| SSO Initiate | `https://smartlead-hub-2.preview.emergentagent.com/api/sso/initiate` |
| SSO Verify | `https://smartlead-hub-2.preview.emergentagent.com/api/sso/verify` |
| SSO User Info | `https://smartlead-hub-2.preview.emergentagent.com/api/sso/user-info` |
| CSV Export | `https://smartlead-hub-2.preview.emergentagent.com/api/integrations/csv-export` |
| CSV List | `https://smartlead-hub-2.preview.emergentagent.com/api/integrations/csv-files` |

### Sendloop Redirect URLs (Proleads uses these)

| Purpose | Full URL |
|---------|----------|
| Dashboard Login | `https://drip-campaign-hub.preview.emergentagent.com/dashboard` |
| CSV Import | `https://drip-campaign-hub.preview.emergentagent.com/import` |
...
**Solution:** Update `PROLEADS_API_URL` to `https://smartlead-hub-2.preview.emergentagent.com`  
