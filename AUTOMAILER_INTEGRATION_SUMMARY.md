...
- ✅ Opens AutoMailer in new tab (`https://payment-flow-70.preview.emergentagent.com/dashboard`)
...
**Preview Environment:**
- Dashboard: `https://payment-flow-70.preview.emergentagent.com/dashboard`
