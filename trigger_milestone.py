...
def trigger_milestone():
    ...
    try:
        ...
        admin_response = requests.post('https://affnet-dashboard-1.preview.emergentagent.com/api/admin/login', json=admin_data)
        admin_token = admin_response.json()['token']
        
        # Get firstuser details
        headers = {'Authorization': f'Bearer {admin_token}', 'Content-Type': 'application/json'}
        members_response = requests.get('https://affnet-dashboard-1.preview.emergentagent.com/api/admin/members?limit=50', headers=headers)
        ...
        login_response = requests.post('https://affnet-dashboard-1.preview.emergentagent.com/api/auth/simple-login', json=login_data)
        ...
        milestones_response = requests.get('https://affnet-dashboard-1.preview.emergentagent.com/api/users/milestones', headers=user_headers)
        ...
        admin_milestones_response = requests.get('https://affnet-dashboard-1.preview.emergentagent.com/api/admin/milestones', headers=headers)
