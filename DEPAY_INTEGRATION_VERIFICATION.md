...
**URL**: `https://marketer-auth-bridge.preview.emergentagent.com/api/payments/depay/configuration`
**Method**: POST
...
**URL**: `https://marketer-auth-bridge.preview.emergentagent.com/api/payments/depay/callback`
**Method**: POST
