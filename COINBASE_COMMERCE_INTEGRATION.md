...
3. **New Webhook Handler**
   ...
   - Webhook URL configured: `https://affiliate-hub-137.preview.emergentagent.com/api/webhooks/coinbase-commerce`
...
**Preview Environment:**
```
URL: https://affiliate-hub-137.preview.emergentagent.com/api/webhooks/coinbase-commerce
