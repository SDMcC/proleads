...
3. **New Webhook Handler**
   ...
   - Webhook URL configured: `https://instant-payout-sys.preview.emergentagent.com/api/webhooks/coinbase-commerce`
...
**Preview Environment:**
```
URL: https://instant-payout-sys.preview.emergentagent.com/api/webhooks/coinbase-commerce
