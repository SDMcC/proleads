...
3. **New Webhook Handler**
   ...
   - Webhook URL configured: `https://marketing-hub-162.preview.emergentagent.com/api/webhooks/coinbase-commerce`
...
**Preview Environment:**
```
URL: https://marketing-hub-162.preview.emergentagent.com/api/webhooks/coinbase-commerce
