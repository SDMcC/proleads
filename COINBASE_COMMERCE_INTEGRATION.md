...
3. **New Webhook Handler**
   ...
   - Webhook URL configured: `https://payment-flow-70.preview.emergentagent.com/api/webhooks/coinbase-commerce`
...
**Preview Environment:**
```
URL: https://payment-flow-70.preview.emergentagent.com/api/webhooks/coinbase-commerce
