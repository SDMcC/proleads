...
3. **New Webhook Handler**
   ...
   - Webhook URL configured: `https://smartlead-hub-2.preview.emergentagent.com/api/webhooks/coinbase-commerce`
...
**Preview Environment:**
```
URL: https://smartlead-hub-2.preview.emergentagent.com/api/webhooks/coinbase-commerce
